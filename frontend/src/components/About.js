      ...
      <div className="container ">
        ...
        {/* {partenaire_container} */}
         ...
         <div className="single-brand">
            <img src="assets/img/partener/enau-removebg-preview.png" alt="" />
          </div>
          <div className="single-brand">
            <img src="assets/img/partener/index-removebg-preview.png" alt="" />
          </div>
          <div className="single-brand">
            <img src="assets/img/partener/kamal lazaar Foundation.png" alt="" />
          </div>
         <div className="single-brand">
            <img src="assets/img/partener/logo club hannibal .jpg" alt="" />
          </div>
         <div className="single-brand">
            <img src="assets/img/partener/logo transparent.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/Logo_Ass__Anciens_Officiers-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/logo_ATOM-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/MARINA GAMART.jpg" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/Ministère_du_tourisme-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/oaca-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/ommpp-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/rbn__1_-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/salim__1_-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/téléchargement-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/téléchargement-removebg-preview.png" alt="" />
          </div> 
          <div className="single-brand">
            <img src="assets/img/partener/we love el jem.jpg" alt="" />
          </div> 
        </div>
      </div>
    </div>
