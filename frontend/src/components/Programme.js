          ...
          <div className="home-blog-single mb-30">
            <div className="blog-img-cap">
              ...
              <div className="blog-cap">
                <h3>
                  <a href={"/" + actualite._id}>{actualite.titre}</a>
                </h3>
                <ReadMoreReact
    ...
    <div>
      ...
      <div className="bodyBg">
        ...
        <div className="home-blog-area">
          <div className="">
            <div className="row">{eventPasse_container}</div>
          </div>
        </div>
      </div>
      <div className="bodyBg">
        ...
        <div className="home-blog-area bodyBg">
          <div className="">
            <div className="row">{ConfPasses_container}</div>
          </div>
        </div>
      </div>
      <div className="bodyBg">
        ...
        <div className="home-blog-area">
          <div className="">
            <div className="row">{sortiePass_container}</div>
          </div>
        </div>
      </div>
      {/* Blog Area End */}
